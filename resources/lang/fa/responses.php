...
return [
    ...
    */
    ...
    'warning'=>[
        'wasExists' => 'عملیات با موفقیت انجام شد. اطلاعات دبیر از قبل موجود بود',
    ],

    'error'=>[
        'data' => 'داده ها اشتباه هستند',
        'orderRepeat' => 'مقدار ترتیب نمیتواند تکراری باشد',
        'oldPassWrong' => 'رمز عبور قبلی اشتباه است',
        'passRepeat' => 'رمز عبور نمیتواند همان رمز عبور قدیمی باشد',
        'dataNotEnough' => 'داده ها کافی نیستند',
        'dateLtNow' => 'تاریخ انتخابی نباید بزرگتر از تاریخ این هفته باشد',
        'messageSelf' => 'شما نمیتوانید به خودتان پیام ارسال کنید',
        'studentNotEnough' => 'ظرفیت دانش آموزان شما به پایان رسیده است. برای افزایش ظرفیت با پشتیبانی تماس بگیرید',
        "dontExist"=> "آیتم وجود ندارد",
        "teacherUpdate"=> "مشخصات این دبیر تنها توسط خودشان قابل تغییر است",
        ...
        "fatherPhoneTaken"=> "تلفن پدر دانش آموز قبلا انتخاب شده است",
        "hasSchedule"=> "به علت استفاده از این زنگ در برنامه کلاسی امکان حذف آن وجود ندارد",
        "phoneTaken"=> "تلفن قبلا انتخاب شده است",
        "wrongPhone"=> "کاربری با این شماره تلفن در سیستم وجود ندارد",
        "emptyWallet"=> "موجودی کیف پول کافی نیست",
